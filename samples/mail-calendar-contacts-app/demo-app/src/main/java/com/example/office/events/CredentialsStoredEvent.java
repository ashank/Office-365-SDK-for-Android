...
public class CredentialsStoredEvent extends AbstractEvent {
	...
	private final IOfficeCredentials credentials;
	 ...
	 */
	public CredentialsStoredEvent(IOfficeCredentials credentials) {
	 ...
	 *
	 * @return	{@link IOfficeCredentials} implementation instance.
	 */
	public IOfficeCredentials getCredentials() {
		return credentials;
	}
}

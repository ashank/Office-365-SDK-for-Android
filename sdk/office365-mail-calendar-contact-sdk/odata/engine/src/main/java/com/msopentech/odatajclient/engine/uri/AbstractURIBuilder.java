...
public abstract class AbstractURIBuilder implements URIBuilder {
    ...
    public URI build() {
        ...
        try {
            final com.msopentech.org.apache.http.client.utils.URIBuilder builder =
                    new com.msopentech.org.apache.http.client.utils.URIBuilder(segmentsBuilder.toString());
